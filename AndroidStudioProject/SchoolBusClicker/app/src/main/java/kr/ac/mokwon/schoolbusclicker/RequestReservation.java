...
{
    //서버 url 설정(php파일 연동)
    final static private String URL = "https://as8794.cafe24.com/bus_clicker/Reservation.php";
    private Map<String, String> map;

    public RequestReservation(String userID, String userName, String bus, String date, int seat, String start, String end, String time, Response.Listener<String> listener)
    {
