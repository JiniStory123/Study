...
public class MainActivityLoginBusFragment extends Fragment
{
    MainActivity main;
    public MainActivityLoginBusFragment()
    {
        super();
    }
    ...
    {
        View view = inflater.inflate(R.layout.activity_main_login_bus_fragment, container, false);
        ...
        btn_login.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View view)
            {
                    ...
                    public void onResponse(String response)
                    {
                        try
                        {
                            ...
                            { // 로그인에 성공한 경우
                                ...
                                // 임시로
                                Intent intent = new Intent(getActivity(), BusMainActivityOld.class);
                ...
                RequestLogin loginRequest = new RequestLogin(userID, userPass, responseListener);
